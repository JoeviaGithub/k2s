(function(e){if("function"==typeof bootstrap)bootstrap("sdp",e);else if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else if("undefined"!=typeof ses){if(!ses.ok())return;ses.makeSDP=e}else"undefined"!=typeof window?window.SDP=e():global.SDP=e()})(function(){var define,ses,bootstrap,module,exports;
...
Media.prototype = {
    ...
    get encryption() {
        ...
        each(cryptoLines, function (attr) {
            ...
            crypto['crypto-suite'] = parsed.shift();
            crypto['key-params'] = parsed.shift();
            if (parsed.length) {
                crypto['session-params'] = parsed.join(' ');
            }
    ...
    set encryption(val) {
        ...
        each(val, function (crypto) {
            self.attributes.push({
                key: 'crypto',
                value: [crypto.tag, crypto['crypto-suite'], crypto['key-params'], crypto['session-params']].join(' ')
            });
        });
    },
    get rtcp() {
